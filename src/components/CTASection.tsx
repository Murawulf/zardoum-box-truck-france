...
const CTASection = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-600 to-blue-800 py-16 text-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1606170033648-5d55a3edf615?q=80&w=2070')] bg-cover bg-center opacity-20"></div>
      <div className="absolute -right-16 bottom-0 opacity-10">
        <Truck className="w-64 h-64 text-white" />
      </div>
      <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">{translate('cta.title')}</h2>
